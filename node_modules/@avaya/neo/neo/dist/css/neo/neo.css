...
@media (prefers-color-scheme: dark) {
  :root .neo-dynamic {
    ...
    --table-nested-row-border-color: #125ab3;
...
@media (prefers-color-scheme: light) {
  :root .neo-dynamic {
    ...
    --table-nested-row-border-color: #abccf5;
...
.neo-typography-reset::-webkit-input-placeholder,
.neo-typography-reset::-moz-placeholder,
.neo-typography-reset::-ms-input-placeholder,
...
.neo-form-control--error[dir="rtl"]
...
.neo-form--inline .neo-form-control .neo-input {
  margin-top: 12px;
}
...
.neo-input-editable__wrapper .neo-input-edit__icon:focus,
.neo-input-editable__wrapper .neo-input-editable__close:focus {
...
.neo-input-group label:last-child {
  padding-bottom: 0px !important;
}
...
[dir="rtl"] .neo-input-icon [class*="aoc-"]:first-child,
[dir="rtl"] .neo-input-icon [class*="neo-icon"]:first-child {
  bottom: 0;
  left: auto;
  position: absolute;
  right: 0;
...
[dir="rtl"] .neo-input-icon [class*="aoc-"]:last-child,
[dir="rtl"] .neo-input-icon [class*="neo-icon"]:last-child {
  bottom: 0;
  left: 0;
  position: absolute;
  right: auto;
...
.neo-btn[dir="rtl"]:not(:empty)::before,
.neo-btn-primary[dir="rtl"]:not(:empty)::before,
.neo-btn-secondary[dir="rtl"]:not(:empty)::before,
.neo-btn-tertiary[dir="rtl"]:not(:empty)::before,
.neo-pagination__item[dir="rtl"]:not(:empty)::before,
.neo-pagination__item-arrow[dir="rtl"]:not(:empty)::before,
...
.neo-btn-primary--primary {
  ...
  background-image: linear-gradient(
    50deg,
    var(--button-hover-color-default-info) 0%,
    var(--button-hover-color-default-info) 50%,
    var(--button-color-primary) 50%,
    var(--button-color-primary) 100%
  );
...
.neo-btn-primary--warning {
  ...
  background-image: linear-gradient(
    50deg,
    var(--button-hover-color-warning) 0%,
    var(--button-hover-color-warning) 50%,
    var(--button-color-warning) 50%,
    var(--button-color-warning) 100%
  );
  background-repeat: no-repeat;
  background-size: 300%;
  background-position: 100% 0%;
...
.neo-btn-primary--alert {
  ...
  background-image: linear-gradient(
    50deg,
    var(--button-hover-color-alert) 0%,
    var(--button-hover-color-alert) 50%,
    var(--button-color-alert) 50%,
    var(--button-color-alert) 100%
  );
  background-repeat: no-repeat;
  background-size: 300%;
  background-position: 100% 0%;
...
.neo-btn-secondary--primary {
  ...
  background-image: linear-gradient(
    ...
    var(--button-secondary-background-color) 50%,
    var(--button-secondary-background-color) 100%
  );
  background-repeat: no-repeat;
  background-size: 300%;
  background-position: 100% 0%;
...
.neo-radio:focus + label:before {
  box-shadow: 0 0px 8px var(--radio-background-active-color);
}
...
.neo-check:disabled + label:checked:disabled {
  font-family: "updated-neo-icons" !important;
  content: "";
  font-size: 11px;
  color: var(--checkbox-icon-color);
...
.neo-check:disabled + label.checked::before {
...
.neo-table tr:not(.disabled):hover td .neo-btn-square {
  display: block;
}
.neo-table tr.active {
  background-color: var(--table-row-hover-color);
...
.neo-table__nested--wrapper--active > td {
  ...
  border-bottom: 3px solid var(--table-nested-row-border-color);
}
...
.neo-pagination__arrow-btn[disabled]:focus {
  outline: none;
}
...
.neo-chip[dir="rtl"]::before,
.neo-chips__item[dir="rtl"]::before {
  margin-right: auto;
  margin-left: 4px;
}
.neo-chip::after,
...
.neo-chip.neo-chip--expandable:focus {
  outline: var(--global-outline-color) auto 2px;
}
...
.neo-tabs__item:not(.neo-tabs__item--active-disabled):not(.neo-tabs__item--disabled):hover {
  transition: background-color, color, 0.4s cubic-bezier(0.25, 0.1, 0.25, 1);
...
[dir="rtl"] .neo-dropdown__item > .neo-dropdown__link::before {
  font-family: "updated-neo-icons";
  color: var(--global-text-inverse-color);
  content: "";
  vertical-align: middle;
...
[dir="rtl"]
  .neo-dropdown__item
  > .neo-dropdown__link:not(.neo-dropdown__link-header)::before {
  position: absolute;
  left: 0px;
  padding: 0 0 0 8px;
  vertical-align: middle;
...
.neo-dropdown__item
  > .neo-dropdown__link:not(.neo-dropdown__link-header)::after {
  position: absolute;
  right: 0px;
  padding: 0 8px 0 0;
  vertical-align: middle;
...
[dir="rtl"] .neo-dropdown > .neo-dropdown__link::before {
  font-family: "updated-neo-icons";
  color: var(--global-text-inverse-color);
  content: "";
  vertical-align: middle;
...
[dir="rtl"] .neo-dropdown__link-header::before {
  font-family: "updated-neo-icons";
  color: var(--global-text-inverse-color);
  content: "";
  vertical-align: middle;
}
[dir="rtl"] .neo-dropdown__link-header:not(.neo-dropdown__link-header)::before {
  position: absolute;
  left: 0px;
  padding: 0 0 0 8px;
  vertical-align: middle;
...
.neo-accordion--hover
  .neo-accordion__header:hover:not(.neo-accordion__header--disabled) {
  background-color: var(--list-hover);
  cursor: pointer;
  transition: background-color 0.4s cubic-bezier(0.25, 0.1, 0.25, 1);
}
